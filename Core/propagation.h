...
namespace Propagation
{
	...
	void propagate_inside_polygon(vector<list<HalfEdge *>>& boundary_edges, Partition* graph, Segment_Regularization_Tree* tree, map<int, double> & angles, vector<int> & bin_to_angle_index, vector<Ray *> & rays, vector<Segment *> & segments, int &n_init_vertices);
